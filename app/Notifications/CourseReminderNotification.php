...
class CourseReminderNotification extends Notification
{
    ...
    {
        $notify_info = ":bell: *Online Course Reminder* for: " .$this->today. " :bell:";
        $notify_info1 = "The Following Class has a ZOOM Session today: *" .$this->name. " from " .$this->start_date." to ".$this->end_date."*";
