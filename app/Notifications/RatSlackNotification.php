...
class RatSlackNotification extends Notification
{
    use Queueable;
    ...
    public function toSlack($notifiable)
    {
        ...
        $notify_info = "*NOTE* #REF Found in Upcoming Course signup tracking sheet";
        $notify_info1 = "Values for *".$this->name. " from ".$this->start_date." to ".$this->end_date."* Are #REF, Please rectify the situation immediately";
