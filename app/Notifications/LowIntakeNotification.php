...
class LowIntakeNotification extends Notification
{
    use Queueable;
    ...
    public function toSlack($notifiable)
    {
        ...
        $notify_info = ":bell: *Low Intake Alert!* for: *".$this->name.' from '. $this->start_date .' to '.$this->end_date."* :bell:";
        $notify_info1 = "The following class has an intake of : *" .$this->intake."*";
