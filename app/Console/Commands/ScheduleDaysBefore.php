...
class ScheduleDaysBefore extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:scheduledaysbefore';
     ...
     * @var string
     */
    protected $description = 'Command for creating task for Event Type Days Before';
    ...
    public function handle()
    {
        ...
        $courseMains = $courseTriggersService->getAllCourseTriggersForEventWhen(1, NULL);
        // dd($courseMains);
        ...
        foreach ($courseMains as $courseMain) {
            ...
            $searchDate = Carbon::now()->addDays($courseMain->no_of_days);
