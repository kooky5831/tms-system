...
class ScheduleTimeOfMonth extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:scheduletimeofmonth';
     ...
     * @var string
     */
    protected $description = 'Command for creating task for Event Type Time Of Month';
    ...
    public function handle()
    {
        ...
        $courseMains = $courseTriggersService->getAllCourseTriggersForEventWhen(2, $dayOfMonth);
