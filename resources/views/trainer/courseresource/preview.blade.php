                                ...
                                @foreach($resourcesData as $resource)
                                    <li class="list-group-item w-100 mt-3 d-flex align-items-center">
                                        ...
                                        <span class="btn-icon-group-style d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('trainer.course-resources.edit', $resource->id) }}" class="download-icon-link d-inline-block btn btn-dark btn-sm mr-2">
                                                <i class="dripicons-pencil pencil-icon"></i>
                                            </a>
                                            <a href="{{ route('trainer.course-resources.remove-resource', $resource->id) }}" class="download-icon-link d-inline-block btn btn-danger btn-sm mr-2">
