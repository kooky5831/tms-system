...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('trainer.course-resources.index')}}">Course Resources</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('trainer.course-resources.add') }}" method="POST" id="coursecoursetriggeradd" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
