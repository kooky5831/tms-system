...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('trainer.profile') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-2 align-self-center met-profile">
                                <div class="met-profile-main">
                                    <div class="met-profile-main-pic">
                                        <img src="{{ asset('assets/images/users').'/'.Auth::user()->profile_avatar }}" alt="profile-img" id="profile-img" class="rounded-circle w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
