...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('trainer.dashboard') }}" class="btn btn-primary btn-info mb-4 float-right">Back To Dashboard</a>
...
$(function () {
    ...
    var table = $('#datatable').DataTable({
        ...
        "bAutoWidth": false,
        ajax: {
            url: "{{ route('trainer.dashboard.listdatatable_mark', $courseId) }}",
