...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('trainer.dashboard.edit', $examMainData->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                                    ...
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="col-md-1">
                                                            ...
                                                            <label class="customcheck">
                                                                ...
                                                                @if($assessment->trainee_view_access == 1) 
                                                                checked 
                                                                @endif>
...
function initCourseSearch() {
    ...
    $(".f2f_course_id").select2({
        ...
        ajax: {
            url: "{{ route('trainer.ajax.search.courseruns') }}",
            type: "get",
            dataType: "JSON",
