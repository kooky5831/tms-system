...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{route('trainer.dashboard.add')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <div data-repeater-item="">                                   
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="time" id="assessment_time" name="assessments[0][assessment_time]" class="form-control assessment_time">
                                                </div>

                                                <div class="col-md-2">
                                                    <label for="appt">Exam Duration (HH:MM)</label>
                                                    <input type="text" id="durationInput"  name="assessments[0][assessment_duration]" class="form-control durationInput">
                    ...
                    <div class="card-footer m-0 clearfix">
                        ...
                        <a href="{{ route('trainer.dashboard') }}" class="btn btn-danger">Cancel</a>
                    </div>
