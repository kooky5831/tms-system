...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.user.superadmin.add') }}" id="addsuperadmin" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- <h5 class="card-header bg-secondary text-white mt-0">Add User</h5> -->
                    <div class="card-body">
                        <h4 class="header-title mt-0">Add Manager</h4>
                        <div class="row">
                        <div class="col-md-10">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('username') }}" name="username" id="username" placeholder="">
                                    @error('username')
                                        <label class="form-text text-danger">{{ $message }}</label>
                                    @enderror
                                </div>
