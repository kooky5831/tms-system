...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.refreshers.edit', $data->id) }}" id="courserefresher_edit" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer m-0 clearfix">
                        ...
                        <a href="{{ route('admin.course.courserunview', $data->course_id) }}" class="btn btn-danger">Cancel</a>
                    </div>
                </form>
            </div><!--end card-->
        </div> <!--end col-->
