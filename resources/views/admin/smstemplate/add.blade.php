...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Add SMS Template</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('admin.smstemplates.add') }}" method="POST" id="smstemplatesadd" enctype="multipart/form-data" novalidate>
                    @csrf
                    <!-- <h5 class="card-header bg-secondary text-white mt-0">Add Course</h5> -->
                    <div class="card-body">
                        <h4 class="header-title mt-0">Add SMS Template</h4>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="content" name="content" class="form-control h-auto" rows="8" required>{{old('content')}}</textarea>
                                    @error('content')
                                        <label class="form-text text-danger">{{ $message }}</label>
                                    @enderror
                                </div>
