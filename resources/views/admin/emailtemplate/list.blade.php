...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary px-4 btn-rounded float-right mt-0 mb-3" href="{{ route('admin.emailtemplates.add') }}"><i class="add-new"></i> Add New</a>
                    <h4 class="header-title mt-0">Email Templates List</h4>
...
<script type="text/javascript">
    $(function () {
        ...
        var table = $('#datatable').DataTable({
            ...
            aaSorting: [[ 0, "DESC" ]],
            ajax: {
                url: "{{ route('admin.emailtemplates.listdatatable') }}",
