...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.assessments.exam-settings.list') }}" class="btn btn-primary btn-info mb-4 float-right">Back</a>
...
<script>
    $(function(){
        ...
        var table = $('#datatable').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: "{{ route('admin.ajax.get-main-assessments') }}",
