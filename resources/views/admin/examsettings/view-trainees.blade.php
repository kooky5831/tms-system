...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.assessments.examdashboard.examdashboard') }}" class="btn btn-primary btn-info mb-4 float-right">Back</a>
...
$(function () {
    ...
    var table = $('#datatable').DataTable({
        ...
        order: [[3, 'desc']],
        ajax: {
            url: "{{ route('admin.assessments.examdashboard.list_view_trainees', $courseRunId) }}",
