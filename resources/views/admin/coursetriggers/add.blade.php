                ...
                <form action="{{ route('admin.coursetrigger.add') }}" method="POST" id="coursecoursetriggeradd" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="triggerTitle" id="triggerTitle" class="form-control" value="{{ old('triggerTitle') }}" />
                                    @error('triggerTitle')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" style="{{ in_array(old('event_when'), [2,3]) ? 'display:none;' : '' }}" id="noOfDaysDiv">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="coursemain">Select Course <span class="text-danger course-required" style="display:none;">*</span></label>
                            ...
                            <div class="col-md-12" style="{{old('event_type') != 1 && empty(old('template_name')) ? 'display:none;' : '' }} {{old('event_type') == 1 ? '' : 'display:none;' }}" id="emailTemplateDiv">
                                ...
                                <select name="template_name" id="template_name" class="form-control select2">
                                    ...
                                    <option value="{{$template->subject}}__!!__{{$template->slug}}" {{ old('template_name') == $template->subject."__!!__".$template->slug ? 'selected' : '' }}>{{ ucwords($template->subject) }} - {{ $template->description }} </option>
                                    @endforeach
                                </select>
                                @error('template_name')
                                    <label class="form-text text-danger">{{ $message }}</label>
