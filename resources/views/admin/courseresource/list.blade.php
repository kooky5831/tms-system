...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary px-4 btn-rounded float-right mt-0 mb-3" href="{{ route('admin.course-resources.add') }}"><i class="add-new"></i> Add New</a>
...
<script type="text/javascript">
    $(function () {
        ...
        var table = $('#datatable').DataTable({
            ...
            aaSorting: [[ 0, "DESC" ]],
            ajax: {
                url: "{{ route('admin.course-resources.listdatatable') }}",
