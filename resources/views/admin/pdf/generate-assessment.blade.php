...
<body style="font-family: 'firasansfont', sans-serif; font-size: 14px;">
    ...
    <table style="width: 100%;border: none;border-collapse: collapse;">
        <tr>
            <td style="width:70%;border: none;text-align:left;">
            ...
            <td style="width:30%;border: none;vertical-align: bottom;">
                <table style="border: none;">
                    <tr style="border: none;">
                        <td style="border: none;padding-top:10px;"><strong>Assessor Name: </strong></td>
                        <td style="width:170px;border: none;border-bottom: 1px solid #000;"></td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;padding-top:20px;"><strong>Assessor Signature: </strong></td>
                        <td style="width:170px;border: none;border-bottom: 1px solid #000;padding-bottom:10px;"></td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;padding-top:28px;"><strong>Trainer's Name: </strong></td>
                        <td style="border: none;border-bottom: 1px solid #000;text-align:center;padding-top:28px;">{{$result->maintrainerUser->name}}</td>
                    </tr>
                    <tr style="border: none;">
                        <td style="border: none;padding-top:20px;"><strong>Trainer's Signature: </strong></td>
                        <td style="width:170px;border: none;border-bottom: 1px solid #000;"></td>
                    </tr>
                </table>
            </td>
    ...
    <table style="width: 100%;border-collapse: collapse;">
        <tr>
            <thead>
                <th style="width: 10%;padding:5px;text-align: right;border:none;"></th>
                <th style="padding:5px;text-align: center;">Name</th>
                <th style="padding:5px;text-align: center;">Company</th>
                <th style="padding:5px;text-align: center;background-color: #FFFFE0;">NRIC</th>
                <th style="padding:5px;text-align: center;background-color: #FFFFE0;">ID Verification</th>
                <th style="padding:5px;text-align: center;background-color: #f9d4d4;">Assessment Results</th>
                <th style="padding:5px;text-align: center;background-color: #f9d4d4;">Remarks</th>
            </thead>
            <tbody>
                <?php $c = 1; ?>
                @foreach ($result->courseActiveEnrolments as $e => $enrolment)
                    <tr>
                        ...
                        <td style="width: 15%;height: 45px;"></td>
                        <td style="width: 15%;height: 45px;"></td>
                        <td style="height: 45px;"></td>
                    </tr>
                @endforeach
                @foreach ($result->courseActiveRefreshers as $e => $enrolment)
                    @if( $enrolment->isAssessmentRequired )
                        <tr>
                            <td style="width: 3%;padding:5px;text-align: right;border:none;border-left: none;">{{ $c++ }}</td>
                            <td style="width: 15%;padding:5px;text-align: center;">{{ $enrolment->student->name }}</td>
