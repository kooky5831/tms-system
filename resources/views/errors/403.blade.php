...
.container { text-align: center; margin: 6rem 0.5rem 0; }
.container h1 { font-family: var(--font-header); font-size: calc(4rem + 2vw); text-transform: uppercase; }
.container p { text-transform: uppercase; letter-spacing: 0.2rem; font-size: 2rem; margin: 1.5rem 0 3rem; }
svg.keyhole { height: 82px; width: 82px; opacity: 0; visibility: hidden;
...
svg.key { height: 164px; width: 164px; position: absolute; opacity: 0; visibility: hidden;
  /* define an animation for the keyhole, to introduce it
  paused by default, run with a timeout in JavaScript
  */
  animation: showKey 0.5s 0.5s paused ease-out forwards;
...
.ghost {
  ...
  position: absolute; bottom: 5px; left: calc(50% - 100px); width: 200px; height: 200px;
...
.ghost:before {
  ...
  color: var(--color-theme); border-radius: 50%; position: absolute; font-size: 16px;
  bottom: 100%; text-align: center; line-height: 2; padding: 1rem; visibility: hidden;
  opacity: 0;
