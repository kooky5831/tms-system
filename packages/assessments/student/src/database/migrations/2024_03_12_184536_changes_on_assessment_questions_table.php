...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('assessment_questions', function (Blueprint $table) {
            $table->dropIndex('assessment_questions_deleted_at_index');
        ...
        Schema::rename('assessment_questions', 'tms_questions');
    }
    ...
    public function down(): void
    {
        ...
        Schema::table('tms_questions', function (Blueprint $table) {
            $table->integer('assessment_id')->change();
            $table->renameColumn('assessment_id', 'exam_id');
            $table->dropColumn('created_by');
            $table->dropColumn('updated_by');
        });
        Schema::rename('tms_questions', 'assessment_questions');
