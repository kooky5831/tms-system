                        ...
                        <div class="card-body">
                            <div class="px-3">
                                ...
                                <div class="text-center auth-logo-text">
                                    <h4 class="mt-0 mb-3 mt-5">Welcome to Student Assessment Portal</h4>
                                    <p class="text-muted mb-0">Sign in to portal and start your examination.</p>
                                ...
                                <form class="form-horizontal auth-form my-4" method="POST" action="{{route('student.login')}}" id="">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-1">
                                            ...
                                            <input type="text" class="form-control" id="user_id" name="user_id" placeholder="Enter User ID" value="{{ old('email') }}" required autofocus>
                                        </div>
                                        {{-- @if ($errors->has('email'))
                                        <div class="ml-3 text-danger"><p>{{ $errors->first('email') }}</p></div>
                                        @endif --}}
                                    </div><!--end form-group-->
